//
// Created by MOMO on 11/8/21.
//

#include "AudioChannel.h"

AudioChannel::AudioChannel(Playstatus *playstatus, int sample_rate, CallJava *callJava) {
...
void *decodPlay(void *data) {
    AudioChannel *wlAudio = (AudioChannel *) data;
...
int AudioChannel::resampleAudio(void **pcmbuf) {
...
void pcmBufferCallBack(SLAndroidSimpleBufferQueueItf bf, void *context) {
    AudioChannel *wlAudio = (AudioChannel *) context;
    if (wlAudio != NULL) {
...
int AudioChannel::getCurrentSampleRateForOpensles(int sample_rate) {
    int rate = 0;
    switch (sample_rate) {
        case 8000:
...
void AudioChannel::setVolume(int percent) {
...
void AudioChannel::setMute(int mute) {
...
int AudioChannel::getSoundTouchData() {
//        重新整理波形  sountouch
